...
api.delete('/categoria/delete',md_auth.ensureAuth,categoriaController.deleteCategoria);
api.get('/categoria/get',md_auth.ensureAuth,categoriaController.getCategorias);
